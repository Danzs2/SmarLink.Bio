...
<head>
    ...
    <title>Daftar Akun - LinkInBio</title>
...
<body class="bg-white overflow-x-hidden">
    ...
    <div class="flex min-h-screen relative">
        ...
        <a href="/" class="absolute top-6 left-6 md:top-10 md:left-16 lg:left-24 z-50 flex items-center space-x-2 text-gray-500 hover:text-black transition-colors group font-bold text-sm md:text-base bg-white/50 backdrop-blur-sm p-2 rounded-lg lg:bg-transparent lg:p-0">
        ...
        <div class="w-full lg:w-[55%] flex flex-col p-6 sm:p-12 md:p-16 lg:p-24 relative justify-center z-10 bg-white">
            ...
            <div class="max-w-md w-full mx-auto lg:mx-0">
                <div class="mb-8 md:mb-10 text-center lg:text-left">
                    <h1 class="text-3xl md:text-5xl font-black text-gray-900 mb-2 md:mb-3 tracking-tight">Buat akun gratis</h1>
        ...
        <div class="hidden lg:flex lg:w-[45%] bg-[#1E41B2] relative overflow-hidden items-center justify-center border-l border-gray-100">
            ...
            <div class="relative z-10 w-full h-full flex items-center justify-center">
                ...
                <div class="absolute bottom-[15%] left-[5%] w-12 h-12 bg-white rounded-xl flex items-center justify-center text-[#1877F2] shadow-xl rotate-[-10deg] floating-card" style="animation-delay: 1.8s;">
                ...
                <div class="absolute top-[18%] left-[8%] bg-white/95 backdrop-blur-md p-3 rounded-2xl shadow-2xl border border-white z-20 transform -rotate-3 floating-card">
                    <div class="flex items-center space-x-3 text-left">
                        ...
                        <div>
                            <p class="text-[10px] text-gray-400 font-bold uppercase tracking-wider leading-none mb-1">Visits</p>
                            <p class="text-lg font-black text-gray-900 leading-none">1,204</p>
                        </div>
                    </div>
                </div>

                <div class="absolute top-1/4 right-8 space-y-4 z-20">
                    <div class="w-14 h-14 bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] rounded-2xl flex items-center justify-center text-white shadow-2xl rotate-12 floating-card" style="animation-delay: 1s;">
